...
public class W12_03_doWhile_checkGrade {
    public static void main(String[] args) {
        ...
        do {
            System.out.println("Enter your score between 1 and 100: ");  // แสดงข้อความให้ผู้ใช้ป้อนข้อมูล between 1 and 100:
            Score = kb.nextInt();  // รับค่าจากคีย์บอร์ดเก็บไว้ในตัวแปร scor
